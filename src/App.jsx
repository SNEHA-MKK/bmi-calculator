...
function getstatus(bmi){
  ...
  return (
    <>
     <div className='main'>
      <div className='sub p-5 text-center text-success'><h1>BMI CALCULATOR</h1>
       ...
       <form action="" className='mt-5'>
         ...
         <div className=' d-flex justify-content-center align-items-center result  mt-5 shadow flex-column'> 
